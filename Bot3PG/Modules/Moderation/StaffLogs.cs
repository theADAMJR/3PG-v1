...
namespace Bot3PG.Modules.Moderation
{
    public class StaffLogs
    {
        public async Task LogBan(SocketUser socketUser, SocketGuild socketGuild)
        {
            ...
            var logChannel = guild.Config.StaffLogsChannel;
            ...
            embed.AddField("Start", ban.Start.ToString("hh:mm:ss dd/mm/yy"));
            embed.AddField("End", ban.End.ToString("hh:mm:ss dd/mm/yy"));
